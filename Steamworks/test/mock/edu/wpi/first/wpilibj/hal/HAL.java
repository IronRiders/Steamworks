...
public class HAL extends JNIWrapper {
   ...
   *                       the feature string.
   */
  public static int report(int resource, int instanceNumber, int context, String feature) { return 0; }
  ...
  private static int nativeGetAllianceStation() { return 0; }
  ...
  public static short getJoystickAxes(byte joystickNum, float[] axesArray) { return 0; }

  public static short getJoystickPOVs(byte joystickNum, short[] povsArray) { return 0; }

  public static int getJoystickButtons(byte joystickNum, ByteBuffer count) { return 0; }

  public static int setJoystickOutputs(byte joystickNum, int outputs, short leftRumble,
                                              short rightRumble) { return 0; }

  public static int getJoystickIsXbox(byte joystickNum) { return 0; }

  public static int getJoystickType(byte joystickNum) { return 0; }

  public static String getJoystickName(byte joystickNum) { return ""; }

  public static int getJoystickAxisType(byte joystickNum, byte axis) { return 0; }

  public static double getMatchTime() { return 0; }

  public static boolean getSystemActive() { return true; }

  public static boolean getBrownedOut() { return true; }

  public static int setErrorData(String error) { return 0; }
