...
//	private DigitalInput leftGearCheckSwitch;
	public Solenoid rampSolenoid;
	
//	double idealSpeed = 0;

	public Ramp(int solenoidPort/* SparkPort, int upSwitchPort, int downSwitchPort, int leftCheckPort, int rightCheckPort */) {
		rampSolenoid = new Solenoid(solenoidPort);
...
//		leftGearCheckSwitch = new DigitalInput(leftCheckPort);
	...
	public void setState(boolean rampState){
		rampSolenoid.set(rampState);
